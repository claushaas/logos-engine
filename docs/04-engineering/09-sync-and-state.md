...
| Generated files | Markdown/HTML/agent pack files. | Written by `/generate`; user may edit/delete. | No secrets; project content may be sensitive. | Regeneration can update shape. | User deletes files manually. | Missing/manual edit detected where metadata exists. | MVP |
